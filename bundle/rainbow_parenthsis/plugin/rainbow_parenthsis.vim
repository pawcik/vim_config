...
command! -nargs=0 RainbowParenthsisToggle       call rainbow_parenthsis#Toggle()
command! -nargs=0 RainbowParenthsisLoadSquare   call rainbow_parenthsis#LoadSquare()
command! -nargs=0 RainbowParenthsisLoadRound    call rainbow_parenthsis#LoadRound()
command! -nargs=0 RainbowParenthsisLoadBraces   call rainbow_parenthsis#LoadBraces()
command! -nargs=0 RainbowParenthsisLoadChevrons call rainbow_parenthsis#Chevrons()
